...
export default function TalentsSignupPage() {
  ...
  const isUrl = /^https?:\/\/.+/i.test(video.url.trim());
        ...
        <div className="m-wrap" style={{ maxWidth: 560, margin: '0 auto', display: 'flex', flexDirection: 'column', gap: 18 }}>
          ...
          {user && (
            <>
              ...
              <Section title="4. Ta vidéo (1 min)" subtitle="Colle ton lien YouTube / TikTok / Drive / etc. (recommandé) — ou téléverse ton MP4 directement.">
                <VideoUpload
                  userUid={user.uid}
