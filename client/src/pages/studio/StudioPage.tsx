...
const STYLES = `
  ...
  .studio .input { background: rgba(255,250,240,.08); border: 1px solid rgba(255,250,240,.15); border-radius: 12px; padding: 12px 14px; color: ${N.cream}; font-family: 'JetBrains Mono', monospace; font-size: 14px; font-weight: 600; outline: none; width: 100%; }
  .studio .input:focus { border-color: ${N.yellow}; background: rgba(255,250,240,.12); }
  .studio .input::placeholder { color: rgba(255,250,240,.4); }
