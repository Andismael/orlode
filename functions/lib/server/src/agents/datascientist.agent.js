...
exports.dataScientistAgentFlow = genkit_config_1.ai.defineFlow({ name: 'dataScientistAgent', inputSchema: INPUT, outputSchema: OUTPUT }, async ({ request, companyId, language }) => {
    logger_1.logger.info(`[DataScientistAgent] Request: "${request.slice(0, 80)}"`);
...
CompanyID: ${companyId}.
Sois precis, data-driven, et donne des recommandations concretes avec des chiffres.
