...
exports.PLAN_ALIASES = exports.PLAN_AGENT_LIMITS = exports.AGENT_CATALOG = void 0;
...
function resolvePlan(plan) {
    return exports.PLAN_ALIASES[plan] ?? plan;
}
...
function getAvailableAgents(plan) {
    ...
    return exports.AGENT_CATALOG.filter(a => !CORE_AGENT_IDS.has(a.id));
}
/** Count total skills for selected agents */
function countSkills(agentIds) {
    return exports.AGENT_CATALOG
