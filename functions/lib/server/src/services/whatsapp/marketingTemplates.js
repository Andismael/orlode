...
function renderTemplate(name, vars) {
    const t = exports.MARKETING_TEMPLATES[name];
    if (!t)
        throw new Error(`Unknown marketing template: ${name}`);
    return t.body(vars);
}
/**
...
//# sourceMappingURL=marketingTemplates.js.map