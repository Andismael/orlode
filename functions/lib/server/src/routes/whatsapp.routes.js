            ...
            if (companyId === PLATFORM_COMPANY && finalMessage) {
                try {
                    ...
                    if (inflConvSnap && !inflConvSnap.empty) {
                        ...
                        logger_1.logger.info('[InfluencersInbox] Creator reply routed to conversation', {
                    ...
                    logger_1.logger.warn('[TalentsInbox/InfluencersInbox] Routing failed (non-blocking, falling through to orchestrator)', {
