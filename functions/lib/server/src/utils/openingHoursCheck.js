...
exports.isStoreOpen = isStoreOpen;
...
function parseTime(s) {
    ...
    if (Number.isNaN(h) || Number.isNaN(min) || h > 24 || min >= 60)
        return null;
    return h * 60 + min;
}
...
function parseSlots(text) {
    ...
    for (const seg of segments) {
        if (/ferm[ée]/i.test(seg))
            continue; // closed-day segments handled separately
...
//# sourceMappingURL=openingHoursCheck.js.map