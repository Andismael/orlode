...
import { isDataScientistEnabled } from '../config/featureFlags';
...
router.use((req: AuthenticatedRequest, res: Response, next: NextFunction) => {
  if (!isDataScientistEnabled(req.user?.companyId)) {
...
// ── Helpers ────────────────────────────────────────────────────────────────
function rngSparkline(seed: number, n = 12, base = 30, jitter = 18): number[] {
...
// ── GET /snapshot ──────────────────────────────────────────────────────────
router.get('/snapshot', asyncHandler(async (req: AuthenticatedRequest, res: Response) => {
...
// ── GET /correlations ──────────────────────────────────────────────────────
router.get('/correlations', asyncHandler(async (_req: AuthenticatedRequest, res: Response) => {
...
// ── POST /predict ──────────────────────────────────────────────────────────
router.post('/predict', asyncHandler(async (req: AuthenticatedRequest, res: Response) => {
...
// ── GET /auto-insights ─────────────────────────────────────────────────────
router.get('/auto-insights', asyncHandler(async (_req: AuthenticatedRequest, res: Response) => {
  res.json({
    success: true,
    data: [
